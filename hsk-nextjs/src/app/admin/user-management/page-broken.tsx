...
export default function UserManagementPage() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await adminApiRequest(`/api/admin/users?${params}`);
  ...
  useEffect(() => {
    fetchUsers();
  }, [currentPage, searchTerm, roleFilter, statusFilter, deptFilter]);
            ...
            <table className="data-table">
              ...
              <tbody>
                {loading ? (
                  ...
                  const statusBadge = getStatusBadge(user.status || (user.isActive ? 'active' : 'inactive'));
                  return (
                    <tr key={user.id}>
                      <td>
